    ...
    return (
        <>
            <div 
                id="SideNavMain" 
                className={`
                    fixed z-20 bg-white pt-[90px] h-full lg:border-r-0 border-r w-[75px] overflow-auto
            ...
            >
                ...
                <div className="lg:w-full w-[55px] mx-auto">
                    ...
                    <div className="lg:block hidden text-[11px] text-gray-500">
                        <p className="pt-4 px-2">About Updates Clip Shop Support Careers ByteSync</p>
                        <p className="pt-4 px-2">Clipit Impact Advertise Developers Rewards Discover Widgets</p>
                        <p className="pt-4 px-2">Help Safety Privacy Creator Hub Guidelines</p>
