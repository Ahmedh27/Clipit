...
declare module 'nuxt/schema' {
  interface NuxtConfig {
    ...
    modules?: (NuxtModule | string | [NuxtModule | string, Record<string, any>] | ["nuxt-icon", NuxtConfig["icon"]] | ["@pinia/nuxt", NuxtConfig["pinia"]] | ["nuxt-config-schema", NuxtConfig["nuxt-config-schema-compat"]] | ["@pinia-plugin-persistedstate/nuxt", NuxtConfig["piniaPersistedstate"]] | ["nuxt-config-schema", NuxtConfig["nuxt-config-schema"]] | ["@nuxt/telemetry", NuxtConfig["telemetry"]])[],
  }
